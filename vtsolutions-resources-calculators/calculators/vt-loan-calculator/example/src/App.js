        ...
        return (
            <div className="mt-3 col-sm-5 col-lg-7 col-xl-5 text-center">
                ...
                <div className="row">
                    ...
                    <div className="col-5 text-black">{ '$' + Util.formatMoney( Util.roundTo(amount, 2) ) }</div>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="col-5 text-black">{ tableResults[tableResults.length-1].totalInterest }</div>
                </div>
