    ...
    renderSentenceResults = () => {
        ...
        if(lan === 'en'){
            ...
            switch(true){
                ...
                break;
                //If your debt-to-income ratio is greater than 45%:
                case auxRatio > 45: ratioWords = 'You have too much debt and need to take immediate action to avoid financial distress. Talk to a credit counsellor to explore debt relief options.';
                break;
                default: ratioWords = ''; break;
            }
        }
            ...
            switch(true){
                //If your debt-to-income ratio is 36% or less:
                case auxRatio < 36: ratioWords = 'Celle-ci est un endettement sain pour la plupart des gens.  Tant que votre côté de crédit est bon, vous devez être capable d’être approuvé pour un nouveau prêt.';
                break;
                //If your debt-to-income ratio is 36% - 45%: 
                case auxRatio >= 36 && auxRatio <= 45: ratioWords = 'Vous pouvez explorer des options pour réduire votre endettement.  Vous pouvez avoir de la difficulté d’être approuver pour des nouveaux financements à cause de votre ratio de dette.';
                break;
                //If your debt-to-income ratio is greater than 45%:
                case auxRatio > 45: ratioWords = 'Vous êtes trop endetté et vous devez prendre action immédiatement pour éviter la détresse financière.  Parler avec un conseiller de credit pour explorer des options d’allègement de la dette.';
                break;
                default: ratioWords = ''; break;
            }
        }
