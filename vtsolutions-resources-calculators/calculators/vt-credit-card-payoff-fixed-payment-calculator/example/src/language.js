const translations = {
    en : {
        ...
        principalPaidText: 'Principal Paid',
        ...
        disclaimerText2: '* This estimate compares paying your credit card debt on your own vs. the potential benefit of using a Debt Management Plan through completion. IT\'S NOT AN ACTUAL QUOTE. Estimate is based on 2.15% of your balance owed. Actual interest rates will vary by consumer and creditor – yours could be higher or lower. Consolidated Credit might be able to reduce your interest rates and late fees allowing you to pay off your credit card debt quicker (since more payments are applied to your principal balances, saving you lots of money in the long run). To complete the program, you must make on-time payments each month. Late or missed payments may cause your program to be cancelled and in that event, this estimate would not apply to you.',
        loadingText: 'Loading...',
    ...
    ca : {
        ...
        cautionText: 'CAUTION',
        disclaimerText: 'Federal regulations require credit card issuers to disclose on your credit card statement how long it will take to pay off your estimated balance if you make minimum monthly payments. Estimates may be rounded up to the next $100. This debt calculator uses your actual credit card balance, so the results may vary from the estimate shown in your credit card statement.',
        disclaimerText2: '* This estimate compares paying your credit card debt on your own vs. the potential benefit of using a Debt Management Plan through completion. IT\'S NOT AN ACTUAL QUOTE. Estimate is based on 2.5% of your balance owed. Actual interest rates will vary by consumer and creditor – yours could be higher or lower. Consolidated Credit might be able to reduce your interest rates and late fees allowing you to pay off your credit card debt quicker (since more payments are applied to your principal balances, saving you lots of money in the long run). To complete the program, you must make on-time payments each month. Late or missed payments may cause your program to be cancelled and in that event, this estimate would not apply to you.',
        loadingText: 'Loading...',
        goToPaymentScheduleText: 'Show Payment Schedule',
        paymentTypeLabel: 'Select a payment schedule based on:',
        paymentTypeLabelTooltip: 'This is a set amount of money you are willing to spend each month to pay off your credit card, regardless of the amount owed. It must be greater than or equal to your first minimum monthly payment.',
