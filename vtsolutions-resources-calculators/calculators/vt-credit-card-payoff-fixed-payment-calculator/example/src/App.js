...
class App extends Component {
    ...
    handleSubmit(e){
        e.preventDefault();
        const {region, currentBalance, apr, balancePercentage, minimumPayment, fixedPayment, paymentType} = this.state;
        ...
        let paymentScheduleUrl = apiUrl + '/getPayments/' + currentBalance + '/' + apr + '/' + balancePercentage + '/' + 25;
        if(region==='ca'){
            checkInfinityPaymentUrl = apiUrl + '/validatePayments/' + currentBalance + '/' + apr + '/' + balancePercentage + '/' + 20;
            paymentScheduleUrl = apiUrl + '/getPayments/' + currentBalance + '/' + apr + '/' + balancePercentage + '/' + 20;
          }
