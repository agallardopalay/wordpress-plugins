...
icons.table = <svg aria-hidden="true" role="img" focusable="false" className="dashicon dashicons-editor-table" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
	<path d="M18 17V3H2v14h16zM16 7H4V5h12v2zm-7 4H4V9h5v2zm7 0h-5V9h5v2zm-7 4H4v-2h5v2zm7 0h-5v-2h5v2z" />
</svg>;

icons.column = <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" role="img" aria-hidden="true" focusable="false">
...
icons.twoLeftWideMd8 = <svg viewBox="0 0 60 30" height="26" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd"
	 clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="1.414">
	<rect x="45" y="0" width="12" height="30" fill="#6d6a6f"/>
	<rect x="0" y="0" width="42" height="30" fill="#6d6a6f"/>
</svg>;

icons.twoLeftWideMd3 = <svg viewBox="0 0 60 30" height="26" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd"
							clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="1.414">
	<rect x="0" y="0" width="12" height="30" fill="#6d6a6f"/>
	<rect x="15" y="0" width="42" height="30" fill="#6d6a6f"/>
</svg>;

icons.twoLeftWideMd10 = <svg viewBox="0 0 60 30" height="26" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd"
							clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="1.414">
	<rect x="48" y="0" width="10" height="30" fill="#6d6a6f"/>
	<rect x="0" y="0" width="45" height="30" fill="#6d6a6f"/>
</svg>;
