                ...
                <div className={className}>
                    <div className="custom-tab-bar" role="tablist">
                        <div className="custom-tab-scroller">
                            ...
                            <div className="custom-tab custom-tab-plus" role="tab" aria-selected="true" onClick={handleAddTab}>
                                <span className="custom-tab__content">
                                    <span className="custom-tab__icon" aria-hidden="true">
                                        {plus}
                                    </span>
                                </span>
                                <span className="custom-tab-indicator">
                                    <span className="custom-tab-indicator__content"></span>
                                </span>
